...
// FIXME: Internet said 220 PPI. But PPI != DPI...
 ...
 */
// FIXME: Need clarification from lvgl devs.
#define LV_DISP_SMALL_LIMIT  30
#define LV_DISP_MEDIUM_LIMIT 50
#define LV_DISP_LARGE_LIMIT  70

/* Type of coordinates. Should be `int16_t` (or `int32_t` for extreme cases) */
// FIXME: Might want to use a VITASDK typedef here. iirc, sceInt16_t or something?
...
// FIXME: I am very certain that although libc malloc/free are good, there might be a better one
//        within VITASDK to use.
